<?php
namespace Meigee\ProductWidget\Block\Product\ProductsList;

/**
 * Interceptor class for @see \Meigee\ProductWidget\Block\Product\ProductsList
 */
class Interceptor extends \Meigee\ProductWidget\Block\Product\ProductsList implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSortBy');
        if (!$pluginInfo) {
            return parent::getSortBy();
        } else {
            return $this->___callPlugins('getSortBy', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getNewProductsCollection');
        if (!$pluginInfo) {
            return parent::getNewProductsCollection();
        } else {
            return $this->___callPlugins('getNewProductsCollection', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBestSellersCollection');
        if (!$pluginInfo) {
            return parent::getBestSellersCollection();
        } else {
            return $this->___callPlugins('getBestSellersCollection', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFeaturedCategoryProductsCollection');
        if (!$pluginInfo) {
            return parent::getFeaturedCategoryProductsCollection();
        } else {
            return $this->___callPlugins('getFeaturedCategoryProductsCollection', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSaleProductsCollection');
        if (!$pluginInfo) {
            return parent::getSaleProductsCollection();
        } else {
            return $this->___callPlugins('getSaleProductsCollection', func_get_args(), $pluginInfo);
        }
    }
