<?php
namespace Meigee\CategoriesEnhanced\Block\Html\MeigeeTopmenu;

/**
 * Interceptor class for @see \Meigee\CategoriesEnhanced\Block\Html\MeigeeTopmenu
 */
class Interceptor extends \Meigee\CategoriesEnhanced\Block\Html\MeigeeTopmenu implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Framework\Data\Tree\NodeFactory $nodeFactory, \Magento\Framework\Data\TreeFactory $treeFactory, \Magento\Catalog\Model\CategoryFactory $categoryFactory, \Magento\Framework\App\Config\ScopeConfigInterface $scopeConfig, \Magento\Store\Model\StoreManagerInterface $storeManager, \Magento\Cms\Model\Template\FilterProvider $filterProvider, \Magento\Catalog\Helper\Output $helperCat, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $nodeFactory, $treeFactory, $categoryFactory, $scopeConfig, $storeManager, $filterProvider, $helperCat, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDesignDir');
        if (!$pluginInfo) {
            return parent::getDesignDir();
        } else {
            return $this->___callPlugins('getDesignDir', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getValHtml');
        if (!$pluginInfo) {
            return parent::getValHtml($val);
        } else {
            return $this->___callPlugins('getValHtml', func_get_args(), $pluginInfo);
        }
    }
